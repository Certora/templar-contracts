...
impl<T: BorshDeserialize + BorshSerialize + TemplarNondet + Clone, const CHUNK_SIZE: u32> TemplarNondet
    for ChunkedAppendOnlyList<T, CHUNK_SIZE>
{
    fn nondet() -> Self {
        Self {
...
impl<'a, T: BorshSerialize + BorshDeserialize + TemplarNondet + Clone, const CHUNK_SIZE: u32>
    IntoIterator
